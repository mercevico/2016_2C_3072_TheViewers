...
namespace TGC.Group.Camara
{
    ...
    public class PvZCamera : TgcCamera
    {
        ...
        public PvZCamera(Vector3 target, float offsetHeight, float offsetForward) : this()
        {
            Target = target;
        ...
        public PvZCamera(Vector3 target, Vector3 targetDisplacement, float offsetHeight, float offsetForward)
            : this()
        {
            Target = target;
        ...
        public void changeGameMode(TgcMesh selectedMesh)
        {
            this.thirdPersonCamera = !this.thirdPersonCamera;
            Target = selectedMesh.Position;
        }
        /// <summary>
        ...
        public void resetValues()
        {
            ...
            position = new Vector3(0, 140, 500);
        }
